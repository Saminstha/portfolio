...
function About() {
  const highlights = [
    { icon: "🎓", label: "Computer Engineering Graduate" },

    { icon: "💻", label: "Full-Stack Developer" },

    { icon: "🤖", label: "AI / ML Enthusiast" },

    { icon: "⚙️", label: "Python & JavaScript" },
  ];
        ...
        <div className="about-layout">
          <div className="about-image-col">
            <div className="about-img-wrapper">
              ...
              <div className="about-badge">
                <div className="about-badge-label">Education</div>
          ...
          <div className="about-text-col">
            ...
            <div className="about-paragraphs">
              ...
              <p>
                {" "}
                I'm a <strong>Computer Engineering student</strong> focused on{" "}
                <strong> Full-Stack Web Development</strong>. I have hands-on
                project experience building complete web applications using the{" "}
                <strong> MERN stack and Django</strong>.{" "}
              </p>{" "}
              <p>
                {" "}
                I work with{" "}
                ...
                , building responsive frontend interfaces and structured backend
                systems.{" "}
              </p>{" "}
              <p>
                {" "}
                ...
                <strong>
                  full-stack Student Management System, Instagram Clone, and
                  News Portal
                </strong>
                , covering frontend development, backend APIs, database design,
                validation, and complete CRUD functionality.{" "}
              </p>{" "}
              <p>
                {" "}
                Beyond web development, I also have experience in{" "}
                <strong>
                  {" "}
                  Artificial Intelligence and Computer Vision
                </strong>{" "}
                through projects such as real-time violence detection and
